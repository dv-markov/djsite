"""
Django settings for valveadvisor project.
...
SECRET_KEY = 'django-insecure-(w6*h=vx11g)d+!wk=bvncpdmhebcj#ne9m!n!wib*!96_2^_x'
...
ROOT_URLCONF = 'valveadvisor.urls'
...
WSGI_APPLICATION = 'valveadvisor.wsgi.application'
...
# специальная константа для адреса после успешной авторизации
# LOGIN_REDIRECT_URL = '/'
